...
<p>
  <img src="docs/images/bvh.jpg" alt="Визуализация BVH" width="720">
  <br>
  <sub><i>Визуализация BVH-дерева, построенного над треугольниками меша.</i></sub>
</p>

<p>
  <img src="docs/images/experimentbvh.jpg" alt="Эксперимент с BVH" width="720">
  <br>
  <sub><i>Эксперимент с использованием BVH-ускорителя для поиска пересечений.</i></sub>
</p>
